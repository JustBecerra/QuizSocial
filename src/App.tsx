      ...
      <Card className="max-w-md w-full">
        <div className="text-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-6">
            ...
            <button className="flex-1 px-6 py-3 bg-gray-200 cursor-pointer hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-semibold rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg">
              Submit Question
            </button>
          </div>
        </div>
